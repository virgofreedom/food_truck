...
for ($i=0;$i < $count_item;$i++){
    ...
    <tr>
        ...
        onkeyup="get_sub('."'".$items[$i]->qty_form."',"."'".$items[$i]->price."',"."'".$items[$i]->qty_form."s'".');sumItem();" 
...
<tr>
    <td>Topping :</td>
    <td>
        <select id="topping" name="topping" onchange="sumItem();">
...
<td><span name='ts' id='total' style="color:red" oninput="total()" >0</span></td>
</tr>
<tr>
    <td></td>
